...
CREATE TABLE IF NOT EXISTS `ea-yukihidemitsuoka2.iam_access_mgmt.principal_catalog` (
...
CREATE TABLE IF NOT EXISTS `ea-yukihidemitsuoka2.iam_access_mgmt.google_groups` (
...
CREATE TABLE IF NOT EXISTS `ea-yukihidemitsuoka2.iam_access_mgmt.google_group_membership_history` (
...
CREATE TABLE IF NOT EXISTS `ea-yukihidemitsuoka2.iam_access_mgmt.gcp_resource_inventory_history` (
  execution_id STRING NOT NULL,
  assessed_at TIMESTAMP NOT NULL,
...
CREATE TABLE IF NOT EXISTS `ea-yukihidemitsuoka2.iam_access_mgmt.iam_status_master` (
